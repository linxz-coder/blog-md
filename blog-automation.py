...
def main():
    # 设置路径
    blog_md_path = "/path/to/blog-md"
    post_for_zola_path = "/path/to/post_for_zola"
    zola_content_path = "/path/to/zola-basic/content/blog"
    ...
    git_operations("/path/to/zola-basic")
